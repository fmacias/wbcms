...
function mainContainer(nwidth, nheight)
{
    ...
    this.setSourceCodeView = function()
    {
        ...
        this.editor.container.oElement.style.display = "none";
        //
        if (this.tree.separator.oElement)
            this.tree.separator.oElement.style.display = "none";
        if (this.preview.separator.oElement)
            this.preview.separator.oElement.style.display = "none";
        if (this.editor.separator.oElement)
            this.editor.separator.oElement.style.display = "none";
        //
